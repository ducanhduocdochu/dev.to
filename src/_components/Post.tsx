     ...
     {postDetail.picturePost ? <img
      ...
      <div className="p-5 pb-3">
        <div className="mb-[10px] flex h-[32px] items-center">
          <Button onClick={() => {
            router.push(`/${postDetail.createdById}`)
            return null
          }} type="secondary" className="" classNameProp="!p-0 h-max">
            <img
              src={author?.image || ""}
              style={{ backgroundColor: "#dddddd;" }}
        ...
        <div className="ml-[40px]">
          <Button
            ...
            onClick={() => {
              router.push(`/${postDetail.createdById}/${postDetail.id}`)
              return null
            }}
          >
            <h2 className="mb-1 text-[24px] font-bold leading-[37.5px]">
              {postDetail.title}
            </h2>
          </Button>
          ...
          <div className="mt-[8px] flex justify-between items-center">
            <div className="flex">
              ...
              router.push(`/${postDetail.createdById}/${postDetail.id}`)
              return null
            }} type="secondary" className="group" classNameProp="!py-1 !pl-0 !pr-3 h-9 hover:no-underline hover:bg-[#00000009]">
              ...
              router.push(`/${postDetail.createdById}/${postDetail.id}`)
              return null
            }} type="secondary" className="" classNameProp="!py-1 !pl-2 !pr-3 h-9 hover:no-underline">
                <div className="flex items-center">
                  <CommentIcon />
                  <span className="text-[14px] !text-text3">
