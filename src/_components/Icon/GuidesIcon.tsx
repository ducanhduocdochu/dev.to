            ...
            <g clipPath="url(#clipPath18)" id="g16">
              <g transform="translate(33,30)" id="g22">
                <path
                  ...
                  id="path24"
                  style={{ fill: "#226699", fillOpacity: 1, fillRule: "nonzero", stroke: "none" }}
                ></path>
              </g>
              <g transform="translate(21,10)" id="g26">
                <path
                  ...
                  id="path28"
                  style={{ fill: "#292f33", fillOpacity: 1, fillRule: "nonzero", stroke: "none" }}
                ></path>
              </g>
              <g transform="translate(19,11)" id="g30">
                <path
                  ...
                  id="path32"
                  style={{ fill: "#99aab5", fillOpacity: 1, fillRule: "nonzero", stroke: "none" }}
                ></path>
              </g>
              <g transform="translate(19,11)" id="g34">
                <path
                  ...
                  id="path36"
                  style={{ fill: "#e1e8ed", fillOpacity: 1, fillRule: "nonzero", stroke: "none" }}
                ></path>
              </g>
              ...
              <g transform="translate(19,11)" id="g42">
                <path
                  ...
                  id="path44"
                  style={{ fill: "#ccd6dd", fillOpacity: 1, fillRule: "nonzero", stroke: "none" }}
                ></path>
              </g>
            </g>
          </g>
